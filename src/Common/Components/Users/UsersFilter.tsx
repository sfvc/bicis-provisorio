                ...
                <div className="card-body">
                    ...
                    <form action="#!">
                        <div className="grid grid-cols-1 gap-x-5 md:grid-cols-2 xl:grid-cols-3">
                            <div className="mb-4">
                                <label htmlFor="firstNameInput2" className="inline-block mb-2 text-base font-medium">Nombre y Apellido <span className="text-red-500">*</span></label>
                            ...
                            <div className="mb-4">
                                <label htmlFor="stateInput" className="inline-block mb-2 text-base font-medium">Condicion <span className="text-red-500">*</span></label>
