        ...
        <React.Fragment>
            <div className="card">
                <div className="card-body">
                    <h6 className="mb-4 text-15">Buscador de Unidades</h6>
                    <form action="#!">
                        <div className="grid grid-cols-1 gap-x-5 md:grid-cols-2 xl:grid-cols-3">
                            <div className="mb-4">
                                <label htmlFor="firstNameInput2" className="inline-block mb-2 text-base font-medium">Patente <span className="text-red-500">*</span></label>
                            ...
                            <div className="mb-4">
                                <label htmlFor="stateInput" className="inline-block mb-2 text-base font-medium">Condición <span className="text-red-500">*</span></label>
                            ...
                            <div className="mb-4">
                                <label htmlFor="stateInput" className="inline-block mb-2 text-base font-medium">Tipo <span className="text-red-500">*</span></label>
                                <select defaultValue="Choose..." className="form-select border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 dark:disabled:bg-zink-600 disabled:border-slate-300 dark:disabled:border-zink-500 dark:disabled:text-zink-200 disabled:text-slate-500 dark:text-zink-100 dark:bg-zink-700 dark:focus:border-custom-800 placeholder:text-slate-400 dark:placeholder:text-zink-200" id="stateInput" required>
                                    <option disabled>Choose...</option>
                                    <option>Name</option>
                                </select>
