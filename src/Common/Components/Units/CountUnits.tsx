        ...
        <div className="card-body">
            <div className="grid grid-cols-1 gap-5 md:grid-cols-1 xl:grid-cols-5">
                <div className="px-3 py-6 text-center border rounded-md dark:border-zink-500 border-slate-200">
                    ...
                    <p className="mb-0 text-slate-500 dark:text-zink-200">Activas</p>
                </div>
                <div className="px-3 py-6 text-center border rounded-md dark:border-zink-500 border-slate-200">
                    ...
                    <h4 className="mb-2 fs-4xl"><CountUp className="counter-value" end={5000} />k</h4>
                    <p className="mb-0 text-slate-500 dark:text-zink-200">Inactivas</p>
                </div>
                <div className="px-3 py-6 text-center border rounded-md dark:border-zink-500 border-slate-200">
                    ...
                    <p className="mb-0 text-slate-500 dark:text-zink-200">En viaje</p>
                </div>
                <div className="px-3 py-6 text-center border rounded-md dark:border-zink-500 border-slate-200">
                    ...
                    <p className="mb-0 text-slate-500 dark:text-zink-200">Ancladas</p>
                </div>
                ...
                <div className="px-3 py-6 text-center border rounded-md dark:border-zink-500 border-slate-200">
                    ...
                    <p className="mb-0 text-slate-500 dark:text-zink-200">Con fallas</p>
                </div>
